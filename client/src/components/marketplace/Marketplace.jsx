// ============================================
// FILE: client/src/components/marketplace/Marketplace.jsx
...
const Marketplace = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Chợ - Social Network</title>
      </Helmet>
          ...
          <div className="flex gap-2">
            ...
            <div className="flex bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
              <button
                ...
                className={`p-3 ${viewMode === 'grid' ? 'bg-primary-50 text-primary-500 dark:bg-primary-900/20' : 'text-gray-400'}`}
              >
                <FiGrid className="w-5 h-5" />
              </button>
              <button
                onClick={() => setViewMode('list')}
                className={`p-3 ${viewMode === 'list' ? 'bg-primary-50 text-primary-500 dark:bg-primary-900/20' : 'text-gray-400'}`}
              >
...
const ProductCard = ({ product, viewMode }) => {
  return (
    ...
    >
      <div className={`${viewMode === 'list' ? 'w-48 flex-shrink-0' : 'aspect-square'} bg-gray-100 dark:bg-gray-700 rounded-lg overflow-hidden`}>
        <img
      ...
      <div className={`flex-1 ${viewMode === 'list' ? 'py-2' : 'mt-3'}`}>
        ...
        <p className="text-lg font-bold text-primary-500 mt-1 flex items-center gap-1">
