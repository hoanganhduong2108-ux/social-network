// ============================================
// FILE: client/src/components/feed/StoryCard.jsx
    ...
    >
      <div className="relative w-24 h-36 rounded-xl overflow-hidden bg-gray-200 dark:bg-gray-700">
        ...
        <div className="absolute top-2 left-2">
          <div className="w-8 h-8 rounded-full border-2 border-primary-500 overflow-hidden">
            <img
              src={story.user?.avatar || 'https://ui-avatars.com/api/?background=random&bold=true'}
              alt={story.user?.fullName}
