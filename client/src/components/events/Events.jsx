...
import { FiCalendar, FiPlus, FiSearch, FiMapPin, FiClock, FiUsers } from 'react-icons/fi';
            ...
            {filteredEvents.map((event) => (
              ...
              >
                <div className="aspect-video bg-gray-100 dark:bg-gray-700 rounded-lg overflow-hidden relative">
                  <img
                    src={
                      event.image || 'https://via.placeholder.com/400x225/1877F2/FFFFFF?text=Event'
                    }
                    alt={event.title}
